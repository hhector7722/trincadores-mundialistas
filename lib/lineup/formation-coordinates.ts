...
export const FORMATION_SLOT_ANCHORS: Record<FormationId, FormationSlotAnchor[]> = {
  ...
  "4-2-3-1": [
    ...
    { key: "RCB", accept: ["CB", "RCB", "DFC"], coord: { x: X.IR, y: Y.DEFENSE } },
    { key: "RB", accept: ["RB", "RWB"], coord: { x: X.R, y: Y.DEFENSE } },
    { key: "LDM", accept: ["DM", "CDM", "LDM", "MCD"], coord: { x: X.IL, y: 55 } },
    { key: "RDM", accept: ["DM", "CDM", "RDM", "MCD"], coord: { x: X.IR, y: 55 } },
    { key: "LW", accept: ["LW"], coord: { x: X.L, y: Y.ATTACK } },
    { key: "AM", accept: ["AM", "CAM", "SS"], coord: { x: X.C, y: 42 } },
