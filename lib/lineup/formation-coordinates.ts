...
export const FORMATION_SLOT_ANCHORS: Record<FormationId, FormationSlotAnchor[]> = {
  "4-4-2": [
    ...
    { key: "LCM", accept: ["CM", "DM", "LCM"], coord: { x: X.IL, y: Y.MIDFIELD } },
    { key: "RCM", accept: ["CM", "DM", "RCM"], coord: { x: X.IR, y: Y.MIDFIELD } },
    { key: "RM", accept: ["RM", "RW"], coord: { x: X.R, y: Y.MIDFIELD } },
    { key: "LST", accept: ["ST", "CF", "LST", "DC"], coord: { x: X.IL, y: Y.FORWARD } },
  ...
  "4-3-3": [
    ...
    { key: "LCM", accept: ["LCM", "CM", "LM"], coord: { x: X.IL, y: Y.MIDFIELD } },
    { key: "RCM", accept: ["RCM", "CM", "RM"], coord: { x: X.IR, y: Y.MIDFIELD } },
    { key: "LW", accept: ["LW"], coord: { x: X.L, y: Y.FORWARD } },
    { key: "ST", accept: ["ST", "CF"], coord: { x: X.C, y: Y.FORWARD } },
    { key: "RW", accept: ["RW"], coord: { x: X.R, y: Y.FORWARD } },
  ],
  "4-2-3-1": [
    { key: "GK", accept: ["GK"], coord: { x: X.C, y: Y.GOALKEEPER } },
    { key: "LB", accept: ["LB", "LWB"], coord: { x: X.L, y: Y.DEFENSE } },
    ...
    { key: "RCB", accept: ["CB", "RCB", "DFC"], coord: { x: X.IR, y: Y.DEFENSE } },
    { key: "RB", accept: ["RB", "RWB"], coord: { x: X.R, y: Y.DEFENSE } },
    { key: "LDM", accept: ["DM", "CDM", "LDM", "MCD"], coord: { x: X.IL, y: 48 } },
    { key: "RDM", accept: ["DM", "CDM", "RDM", "MCD"], coord: { x: X.IR, y: 48 } },
  ...
  "3-5-2": [
    ...
    { key: "RCB", accept: ["CB", "RCB", "DFC"], coord: { x: X.IR, y: Y.DEFENSE } },
    { key: "LWB", accept: ["LWB", "LB", "LM"], coord: { x: X.UL, y: Y.HOLDING } },
    { key: "LCM", accept: ["LCM", "CM", "DM"], coord: { x: X.IL, y: Y.MIDFIELD } },
    { key: "CM", accept: ["CM"], coord: { x: X.C, y: Y.MIDFIELD } },
    { key: "RCM", accept: ["RCM", "CM", "DM"], coord: { x: X.IR, y: Y.MIDFIELD } },
    { key: "RWB", accept: ["RWB", "RB", "RM"], coord: { x: X.UR, y: Y.HOLDING } },
    { key: "LST", accept: ["ST", "CF", "LST", "DC"], coord: { x: X.IL, y: Y.FORWARD } },
    { key: "RST", accept: ["ST", "CF", "SS", "RST", "DC"], coord: { x: X.IR, y: Y.FORWARD } },
  ],
  "5-3-2": [
    { key: "GK", accept: ["GK"], coord: { x: X.C, y: Y.GOALKEEPER } },
    { key: "LWB", accept: ["LWB", "LB"], coord: { x: X.UL, y: 70 } },
    { key: "LCB", accept: ["CB", "LCB", "DFC"], coord: { x: X.DL, y: 70 } },
    { key: "CB", accept: ["CB", "DFC"], coord: { x: X.C, y: 70 } },
    { key: "RCB", accept: ["CB", "RCB", "DFC"], coord: { x: X.DR, y: 70 } },
    { key: "RWB", accept: ["RWB", "RB"], coord: { x: X.UR, y: 70 } },
    { key: "LCM", accept: ["LCM", "CM", "LM"], coord: { x: X.IL, y: Y.MIDFIELD } },
  ...
  "5-2-3": [
    ...
    { key: "RCB", accept: ["CB", "RCB", "DFC"], coord: { x: X.DR, y: 70 } },
    { key: "RWB", accept: ["RWB", "RB"], coord: { x: X.UR, y: 70 } },
    { key: "LCM", accept: ["LCM", "CM", "DM"], coord: { x: X.IL, y: Y.HOLDING } },
    { key: "RCM", accept: ["RCM", "CM", "DM"], coord: { x: X.IR, y: Y.HOLDING } },
    { key: "LW", accept: ["LW"], coord: { x: X.L, y: Y.FORWARD } },
    { key: "ST", accept: ["ST", "CF"], coord: { x: X.C, y: Y.FORWARD } },
    { key: "RW", accept: ["RW"], coord: { x: X.R, y: Y.FORWARD } },
  ],
  "3-4-3": [
    ...
    { key: "CB", accept: ["CB", "DFC"], coord: { x: X.C, y: Y.DEFENSE } },
    { key: "RCB", accept: ["CB", "RCB", "DFC"], coord: { x: X.IR, y: Y.DEFENSE } },
    { key: "LM", accept: ["LM", "LWB"], coord: { x: X.L, y: Y.MIDFIELD } },
    { key: "LCM", accept: ["LCM", "CM"], coord: { x: X.IL, y: Y.MIDFIELD } },
    { key: "RCM", accept: ["RCM", "CM"], coord: { x: X.IR, y: Y.MIDFIELD } },
    { key: "RM", accept: ["RM", "RWB"], coord: { x: X.R, y: Y.MIDFIELD } },
    { key: "LW", accept: ["LW"], coord: { x: X.L, y: Y.FORWARD } },
    { key: "ST", accept: ["ST", "CF"], coord: { x: X.C, y: Y.FORWARD } },
    { key: "RW", accept: ["RW"], coord: { x: X.R, y: Y.FORWARD } },
  ],
  "3-4-2-1": [
    ...
    { key: "RCM", accept: ["RCM", "CM"], coord: { x: X.IR, y: Y.MIDFIELD } },
    { key: "RM", accept: ["RM", "RWB"], coord: { x: X.R, y: Y.MIDFIELD } },
    { key: "LAM", accept: ["AM", "LAM", "SS"], coord: { x: X.IL, y: Y.ATTACK } },
    { key: "RAM", accept: ["AM", "RAM", "SS"], coord: { x: X.IR, y: Y.ATTACK } },
    { key: "ST", accept: ["ST", "CF"], coord: { x: X.C, y: Y.FORWARD } },
  ],
};
