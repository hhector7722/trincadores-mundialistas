...
/** Misma caja que marbella StaffBottomNav, pero en flujo al pie del shell (no fixed). */
const TABBAR_NAV_CLASS =
  "tm-app-tabbar relative z-[95] shrink-0 w-full flex h-20 items-center justify-around border-t border-[var(--tm-border)] bg-[var(--tm-tabbar-bg-hex)] px-2 pb-safe shadow-[0_-4px_20px_rgba(0,0,0,0.1)] backdrop-blur-md md:h-16 md:px-8";
