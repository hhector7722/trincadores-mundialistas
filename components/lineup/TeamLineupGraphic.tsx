...
export function TeamLineupGraphic({
  ...
  const pitchMaxW = isModal
    ? "w-full max-w-[min(98vw,18.5rem)]"
    : "w-full max-w-[min(92vw,16.5rem)] sm:max-w-[17rem]";

  return (
    <div className={cn("flex w-full flex-col items-center", className)}>
      <div
        className={cn("flex shrink-0 flex-col items-center self-center", !sized && pitchMaxW)}
        style={
          !sized && isModal
            ? {
