...
export function MatchContextActionsRow({
  ...
  if (layout === "homeCardScheduledStacked") {
    return (
      <div className={cn("flex h-full flex-col items-center justify-start gap-0 leading-none", className)}>
        <div className="flex shrink-0 items-center justify-center px-1">{centerSlot}</div>
        <div className="-mt-1.5 flex shrink-0 items-center justify-center px-1">{predictionSlot}</div>
        {hidePossibleLineups ? null : (
          <div className="-mt-2 flex shrink-0 items-center justify-center px-1">
