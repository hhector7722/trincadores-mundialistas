...
const MATCH_PREDICTIONS_COLUMNS_WITH_OUTCOMES =
  "grid-cols-[auto_minmax(0,2fr)_minmax(2.25rem,1fr)_auto_minmax(0,0.7fr)_minmax(0,0.7fr)_minmax(0,1fr)]";
...
export const MATCH_PREDICTIONS_SUBGRID_ROW_WITH_OUTCOMES =
  "col-span-7 grid h-full grid-cols-subgrid items-center px-2 min-h-0";
