      ...
      <div className="tm-cal-groups-list min-h-0 flex-1 overflow-hidden">
        {groups.map((group) => (
          <button
            ...
            className="tm-cal-group-card flex min-h-0 w-full min-w-0 shrink-0 touch-manipulation items-center transition-colors hover:bg-[rgba(217,255,0,0.1)] active:bg-[rgba(217,255,0,0.16)]"
