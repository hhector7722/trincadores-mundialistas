-- Hector (2026-06-17): permitir reintentos de práctica ilimitados (no puntúan).
...
begin
  ...
  -- Solo permitimos práctica si ya existe un intento oficial enviado (que puntúe).
  if not exists (
    select 1
  ...
  -- Si hay un intento de práctica en curso, lo reanudamos. Si no, creamos uno nuevo.
