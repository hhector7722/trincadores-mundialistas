-- Ventana diaria del quiz: 00:00–23:59 Europe/Madrid (opens_at / closes_at + RPC).
...
begin
  ...
  select qa.expires_at, q.kind, q.scoring_mode, q.closes_at, q.quiz_date
  into v_expires, v_kind, v_scoring_mode, v_closes_at, v_quiz_date
  from public.quiz_attempts qa
