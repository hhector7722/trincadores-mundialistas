...
export type Profile = { id: string; username: string; display_name: string | null; recovery_email: string | null; avatar_url: string | null; created_at: string };
...
export type ConsumeInviteResult = string;
